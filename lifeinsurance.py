...
st.markdown(
    ...
    <div style="background-color: #f0f0f0; color: #000000; padding: 10px; border-radius: 5px;">
        <p>This free calculator was built by <a href="https://www.linkedin.com/in/sherry-jiang-12557332/" target="_blank" style="color: #1a0dab;">Sherry</a> from the Peek team (<a href="https://peek.money" target="_blank" style="color: #1a0dab;">peek.money</a>). If you would like to leave any feedback, feel free to reach out to sherry@peek.money or on LinkedIn.</p>
